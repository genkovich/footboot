...
This license is a legal agreement between you and the British Columbia
Institute of Technology for the use of CodeIgniter Software (the
"Software").  By obtaining the Software you agree to comply with the terms
...
6. Products derived from the Software may not be called "CodeIgniter",
   ...
   permission from British Columbia Institute of Technology.
