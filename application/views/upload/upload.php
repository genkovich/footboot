...
<form id="fileupload" action="upload/do_upload" method="POST" enctype="multipart/form-data">
    ...
    <div class="row fileupload-buttonbar">
        <div class="col-lg-7">
           ...
           <a href="/admin/" style="float:right;"> <button type="button" class="btn btn-success">В админку</button></a>
        </div>
...
{% for (var i=0, file; file=o.files[i]; i++) { %}
    <tr class="template-download fade">
        ...
        <td>
             <span class="embed"><input type="text" size="50" value="{%=file.embed%}"/></span>
        </td>
        <td>
...
<script src="assets/js/file_upload/main.js"></script>
